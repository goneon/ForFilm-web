...
function onDeviceTypeChanged() {
    ...
    if (typeof setInfoSectionVisible === 'function') {
        setInfoSectionVisible(isPro);
    }
    if (isPro && typeof loadDeviceInfoConfig === 'function') {
        // 延迟以等 characteristic 完全 ready
        setTimeout(loadDeviceInfoConfig, 500);
    }
}
